...
const registerUser= asyncHandler(async(req,res)=>{
    ...
    // Now this avatar field contain many propertied but we need first property becaus first property consist of an object which alsoconsist of path of file which is stored locally in our diskstorage
